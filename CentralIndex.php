<?php
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function getEntityAdvertisers( $tag, $where, $limit, $country, $language, $benchmark) {
    $params = array();
    $params['tag'] = $tag;
    $params['where'] = $where;
    $params['limit'] = $limit;
   ...
   *  @return - the data from the api
  */
  public function getEntityAdvertisersBy_location( $location, $limit, $country, $language) {
    $params = array();
