<?php
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function putBusiness( $name, $building_number, $address1, $address2, $address3, $district, $town, $county, $province, $postcode, $country, $latitude, $longitude, $timezone, $telephone_number, $email, $website, $category_id, $category_type, $do_not_display) {
    $params = array();
    $params['name'] = $name;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postCountry( $country_id, $name, $synonyms, $continentName, $continent, $geonameId, $dbpediaURL, $freebaseURL, $population, $currencyCode, $languages, $areaInSqKm, $capital, $east, $west, $north, $south, $claimPrice, $claimMethods, $nokia_country_code, $twilio_sms, $twilio_phone, $currency_symbol, $currency_symbol_html) {
    $params = array();
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postGroupBulk_update( $group_id, $user_id, $data) {
    $params = array();
    $params['group_id'] = $group_id;
    $params['user_id'] = $user_id;
    $params['data'] = $data;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function getToolsPhonecallVerify( $to, $from, $pin, $language) {
    $params = array();
    $params['to'] = $to;
    $params['from'] = $from;
    $params['pin'] = $pin;
