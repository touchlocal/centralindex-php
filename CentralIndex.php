...
<?php
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postEntityAdvertiserLocation( $gen_id, $entity_id, $locations_to_add, $locations_to_remove) {
    $params = array();
    $params['gen_id'] = $gen_id;
    $params['entity_id'] = $entity_id;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postEntityAdvertiser( $entity_id, $tags, $locations, $expiry, $is_national, $language, $reseller_ref, $reseller_agent_id, $publisher_id) {
    $params = array();
    $params['entity_id'] = $entity_id;
    $params['tags'] = $tags;
