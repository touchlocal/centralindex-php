<?php
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postAgency( $agency_id, $country, $name, $description, $active) {
    $params = array();
    ...
    return CentralIndex::doCurl("POST","/agency",$params);
  }
  ...
  */
  public function getAgency( $agency_id) {
    $params = array();
    $params['agency_id'] = $agency_id;
    return CentralIndex::doCurl("GET","/agency",$params);
  }
  ...
  */
  public function deleteAgency( $agency_id) {
    $params = array();
    $params['agency_id'] = $agency_id;
    return CentralIndex::doCurl("DELETE","/agency",$params);
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function putBusiness( $name, $building_number, $branch_name, $address1, $address2, $address3, $district, $town, $county, $province, $postcode, $country, $latitude, $longitude, $timezone, $telephone_number, $additional_telephone_number, $email, $website, $category_id, $category_type, $do_not_display, $referrer_url, $referrer_name) {
    $params = array();
    $params['name'] = $name;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function getContract_logSuccess_by_date( $date, $success) {
    $params = array();
    $params['date'] = $date;
    $params['success'] = $success;
    return CentralIndex::doCurl("GET","/contract_log/success_by_date",$params);
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postEntityAgency( $entity_id, $agency_id) {
    $params = array();
    $params['entity_id'] = $entity_id;
    $params['agency_id'] = $agency_id;
    return CentralIndex::doCurl("POST","/entity/agency",$params);
  }
   ...
   *  @return - the data from the api
  */
  public function deleteEntityAgency( $entity_id, $gen_id) {
    $params = array();
    $params['entity_id'] = $entity_id;
    $params['gen_id'] = $gen_id;
    return CentralIndex::doCurl("DELETE","/entity/agency",$params);
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function getEntityBy_agencyid( $agency_id) {
    $params = array();
    $params['agency_id'] = $agency_id;
    return CentralIndex::doCurl("GET","/entity/by_agencyid",$params);
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postProduct( $product_id, $name, $strapline, $price, $currency, $active, $billing_period) {
    $params = array();
    $params['product_id'] = $product_id;
    $params['name'] = $name;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postSyndicationRenew( $syndication_type, $publisher_id, $entity_id, $group_id, $seed_masheryid, $supplier_masheryid, $country, $reseller_masheryid, $expiry_date) {
    $params = array();
    $params['syndication_type'] = $syndication_type;
    $params['publisher_id'] = $publisher_id;
    $params['entity_id'] = $entity_id;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function getSyndication_logBy_entity_id( $entity_id) {
    $params = array();
    $params['entity_id'] = $entity_id;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postUser( $email, $user_id, $first_name, $last_name, $active, $trust, $creation_date, $user_type, $social_network, $social_network_id, $reseller_admin_masheryid, $group_id, $admin_upgrader, $agency_id) {
    $params = array();
    $params['email'] = $email;
    $params['user_id'] = $user_id;
