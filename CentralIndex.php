<?php
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function getAutocompleteLocz( $str, $country, $language) {
    $params = array();
    $params['str'] = $str;
    $params['country'] = $country;
    $params['language'] = $language;
    return CentralIndex::doCurl("GET","/autocomplete/locz",$params);
  }
   ...
   *  @return - the data from the api
  */
  public function getAutocompleteLoczBy_resolution( $str, $country, $resolution) {
    $params = array();
    $params['str'] = $str;
    $params['country'] = $country;
    $params['resolution'] = $resolution;
    return CentralIndex::doCurl("GET","/autocomplete/locz/by_resolution",$params);
  }
   ...
   *  @return - the data from the api
  */
  public function putBusiness( $name, $building_number, $address1, $address2, $address3, $district, $town, $county, $province, $postcode, $country, $latitude, $longitude, $timezone, $telephone_number, $additional_telephone_number, $email, $website, $category_id, $category_type, $do_not_display, $referrer_url, $referrer_name) {
    $params = array();
    $params['name'] = $name;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postCountry( $country_id, $name, $synonyms, $continentName, $continent, $geonameId, $dbpediaURL, $freebaseURL, $population, $currencyCode, $languages, $areaInSqKm, $capital, $east, $west, $north, $south, $claimPrice, $claimMethods, $nokia_country_code, $twilio_sms, $twilio_phone, $twilio_voice, $currency_symbol, $currency_symbol_html) {
    $params = array();
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postEntityClaim( $entity_id, $claimed_user_id, $claimed_date, $claim_method, $phone_number, $referrer_url, $referrer_name) {
    $params = array();
    $params['entity_id'] = $entity_id;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postLocationSynonymBulk( $filedata) {
    $params = array();
    $params['filedata'] = $filedata;
    return CentralIndex::doCurl("POST","/location/synonym/bulk",$params);
  }
   ...
   *  @return - the data from the api
  */
  public function getLocz( $location_id) {
    $params = array();
    $params['location_id'] = $location_id;
    return CentralIndex::doCurl("GET","/locz",$params);
  }
   ...
   *  @return - the data from the api
  */
  public function postLocz( $location_id, $type, $country, $language, $name, $formal_name, $resolution, $population, $description, $timezone, $latitude, $longitude, $parent_town, $parent_county, $parent_province, $parent_region, $parent_neighbourhood, $parent_district, $postalcode, $searchable_id, $searchable_ids) {
    $params = array();
    $params['location_id'] = $location_id;
    $params['type'] = $type;
    $params['country'] = $country;
    ...
    return CentralIndex::doCurl("POST","/locz",$params);
  }
   ...
   *  @return - the data from the api
  */
  public function getLoczMultiple( $location_ids) {
    $params = array();
    $params['location_ids'] = $location_ids;
    return CentralIndex::doCurl("GET","/locz/multiple",$params);
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function getLookupLocz( $string, $language, $country, $latitude, $longitude) {
    $params = array();
    $params['string'] = $string;
    $params['language'] = $language;
    $params['country'] = $country;
    $params['latitude'] = $latitude;
    $params['longitude'] = $longitude;
    return CentralIndex::doCurl("GET","/lookup/locz",$params);
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postSales_log( $entity_id, $country, $action_type, $publisher_id, $mashery_id, $reseller_ref, $reseller_agent_id, $max_tags, $max_locations, $extra_tags, $extra_locations, $expiry_date) {
    $params = array();
    $params['entity_id'] = $entity_id;
    $params['country'] = $country;
   ...
   *  @return - the data from the api
  */
  public function postSignal( $entity_id, $country, $gen_id, $signal_type, $data_type) {
    $params = array();
    $params['entity_id'] = $entity_id;
    $params['country'] = $country;
    $params['gen_id'] = $gen_id;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function getTokenUpgrade( $entity_id, $portal_name, $language, $price, $max_tags, $max_locations, $contract_length, $ref_id, $flatpack_id) {
    $params = array();
    $params['entity_id'] = $entity_id;
    $params['portal_name'] = $portal_name;
    $params['language'] = $language;
  ...
  */
   ...
   *  @return - the data from the api
  */
  public function postUser( $email, $first_name, $last_name, $active, $trust, $creation_date, $user_type, $social_network, $social_network_id, $reseller_admin_masheryid, $group_id, $admin_upgrader) {
    $params = array();
    $params['email'] = $email;
